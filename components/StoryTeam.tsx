...
const TEAM_DATA: { id: number; name: string; role: string; imageSrc: string }[] = [
  { id: 1, name: 'Kim WANG', role: '品牌主理人', imageSrc: '/images/teammate1.jpg' },
  { id: 2, name: '吴进坤', role: '品牌主理人', imageSrc: '/images/teammate2.jpg' },
  { id: 3, name: '李', role: '业务', imageSrc: '/images/teammate3.jpg' },
  { id: 4, name: '杨小乔', role: '文案策划', imageSrc: '/images/teammate4.jpg' },
  { id: 5, name: '彭正', role: '平面/动效', imageSrc: '/images/teammate5.jpg' },
  { id: 6, name: 'Kim WANG', role: '品牌主理人', imageSrc: '/images/teammate1.jpg' },
  { id: 7, name: '吴进坤', role: '品牌主理人', imageSrc: '/images/teammate2.jpg' },
  { id: 8, name: '杨小乔', role: '文案策划', imageSrc: '/images/teammate3.jpg' },
  { id: 9, name: '彭正', role: '平面/动效', imageSrc: '/images/teammate4.jpg' },
  { id: 10, name: '李欣妮', role: '平面/插画', imageSrc: '/images/teammate5.jpg' },
];
